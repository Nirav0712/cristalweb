        ...
        <div className="cs_hero_content">
          ...
          <div className="cs_hero_text position-relative">
            ...
            <div className="cs_hero_text_wrapper">
              <p className="cs_hero_text cs_medium wow fadeInRight">Grow your business with the best digital marketing solution designed to increase online visibility, attract quality customers, and boost sales. Our expert team provides result-driven services including SEO, social media marketing, branding, content creation, and paid advertising. We use advanced strategies and real-time analytics to deliver measurable growth and long-term success. Whether you&apos;re a startup or an established brand, we help you achieve your goals with powerful, customized digital marketing solutions that truly work.
              </p>
        ...
        <div className="cs_hero_sidebar">
          <div className="cs_top_content">
            <div className="cs_clients_info">
              <a onClick={(e) => { e.preventDefault(); }} aria-label="Play video button" className="cs_video cs_style_1 cs_video_open cs_center cs_radius_50 cs_mb_20 wow zoomIn">
                {/* this is the right side image*/}
                <Image src="/assets/img/teamimg/jensi.png" alt="img" className="cs_video_bg" width={120} height={120} />
              ...
              <div className="cs_clients_heading cs_mb_10">
                ...
                <h3 className="cs_fs_20 mb-0">530+<span className="cs_fs_14 cs_medium">Satisfied client</span></h3>
              </div>
          ...
          <div className="cs_social_links wow fadeInRight">
            <a href="https://www.facebook.com/p/The-Crystal-Engage" aria-label="Social link">
            ...
            <a href="https://www.instagram.com/thecrystalengage_" aria-label="Social link">
            ...
            <a href="https://www.linkedin.com/company/the-crystal-engage/" aria-label="Social link">
