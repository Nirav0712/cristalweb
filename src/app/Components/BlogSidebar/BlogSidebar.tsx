...
const BlogSidebar = () => {
  ...
  //   ]; 
  const chooseContent = [
    { img: 'assets/img/blogs/v1.jpeg', title: 'Simplify Streamline Succeed IT Solutions', content: 'Technology' },
    { img: 'assets/img/blogs/v2.jpeg', title: 'Unlocking Potential Through Technology', content: 'Marketing' },
    { img: 'assets/img/blogs/v3.jpeg', title: 'Supervisor Disapproved of Latest Work.', content: 'Security' },
    // { img: 'assets/img/blogs/v4.jpeg', title: 'Simplify Streamline Succeed IT Solutions', content: 'Security' },
    // { img: 'assets/img/blogs/v5.jpeg', title: 'Unlocking Potential Through Technology', content: 'Security' },
    // { img: 'assets/img/blogs/v6.jpeg', title: 'Supervisor Disapproved of Latest Work.', content: 'Security' },
  ];
                ...
                <div key={i} className="col-12">
                  <div className="cs_post cs_style_1 cs_type_2 cs_radius_10 wow fadeInRight">
                    <Link href="/blog/blog-details" aria-label="Click to read post" className="cs_post_thumbnail cs_radius_8 cs_mb_26 position-relative">
                      <img src={item.img} alt="img" width={692} height={419} />
