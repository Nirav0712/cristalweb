...
const Video2 = () => {
  ...
  const handelClick = () => {
    setIframeSrc("/assets/img/newimgs/Untitled_design.mp4");
    setToggle(true);
  };
  const handelClose = () => {
  ...
  return (
    <section>
      ...
      <div className="container">
        ...
        <div className="cs_video_block cs_style_1 cs_type_1 cs_center cs_bg_filed position-relative wow fadeInUp" data-wow-delay="200ms" data-background="/assets/img/newimgs/imagevidiobg.png">
