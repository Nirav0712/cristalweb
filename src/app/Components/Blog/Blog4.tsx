          ...
          {blogData.map((item, i) => (
            <div key={i} className="col-lg-4 wow fadeInLeft">
              <article className="cs_post cs_style_1 cs_type_1">
                <Link href={`/blog/${item.slug}`} aria-label="Click to read post" className="cs_post_thumbnail position-relative">
                  <img src={item.img} alt="img" width={362} height={235} />
                  <span className="cs_posted_by cs_blue_bg cs_white_color cs_radius_10 text-center position-absolute">
                    <span className="cs_fs_24 cs_bold">{item.dateDay}</span>
                    <span className="cs_fs_12">{item.dateMonth}</span>
                  </span>
                </Link>
                <div className="cs_post_content cs_white_bg">
                  ...
                  <h3 className="cs_post_title cs_fs_22 cs_mb_11">
                    <Link href={`/blog/${item.slug}`} aria-label="Click to read post">{item.title}</Link>
                  </h3>
                  <Link href={`/blog/${item.slug}`} aria-label="Click to read post" className="cs_post_btn cs_medium">
                    <span>Read More</span>
                    <span>
