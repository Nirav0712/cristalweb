          ...
          <div className="col-lg-6">
            <div className="cs_about_thumbnail_wrapper wow fadeInUp">
              <div className="cs_about_thumbnail position-relative">
                <Image src="/assets/img/newimgs/marcating_img.jpg" className="w-[260px] h-[353px] object-cover" alt="img" width={260} height={353} />
              ...
              <div className="cs_about_thumbnail position-relative">
                <Image src="/assets/img/newimgs/marcating_img2.jpg" className="h-[260px] w-[353px] object-contain" alt="img" width={269} height={353} />
