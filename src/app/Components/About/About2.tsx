          ...
          <div className="row cs_gap_y_40">
            <div className="col-lg-5 wow fadeInLeft">
              <div className="cs_about_thumbnail">
                 <Image src="/assets/img/newimgs/5259876.jpg" alt="img" width={564} height={524}   />
              </div>
            </div>
            <div className="col-lg-7">
              <div className="cs_about_content">
                <div className="cs_section_heading cs_style_1 cs_mb_28">
                  ...
                  <h2 className="cs_fs_48 cs_mb_21 wow fadeInUp">Digital Growth Driven by Strategy & Results</h2>
                  <p className="cs_section_heading_text mb-0 wow fadeInUp" data-wow-delay="200ms">We fuel brand growth with strategic digital marketing that improves visibility, attracts the right audience, and drives conversions.</p>
                </div>
                <div className="cs_features_wrapper">
                  <div className="cs_feature_item">
                    <h3 className="cs_fs_24 cs_mb_4">Our Mission</h3>
                    <p className="cs_fs_18 mb-0">We empower businesses with innovative digital marketing and strategic branding solutions that enhance visibility and deliver measurable growth.</p>
                  </div>
                  <div className="cs_feature_item">
                    <h3 className="cs_fs_24 cs_mb_4">Our Vision</h3>
                    <p className="cs_fs_18 mb-0">Our vision is to become a globally trusted creative and digital agency that redefines how brands build meaningful connections.</p>
                  </div>
                </div>
